...
const int JERK_OPEN_POSITION = 0;
const int JERK_TIME = 150;
...
{
  servo.attach(SERVO_PIN);
  servo.write(JERK_OPEN_POSITION);
  delay(JERK_TIME);
  servo.write(CLOSED_POSITION);
  delay(JERK_TIME);
  servo.detach();
